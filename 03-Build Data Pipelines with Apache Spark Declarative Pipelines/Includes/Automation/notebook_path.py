...
COURSE_NAME = "Build Data Pipelines with Apache Spark Declarative Pipelines"
RUN_QA_CHECKER = True
...
COURSE_TASKS = [
    {
        "task_key": "02 Demo - Course Setup and Creating a Pipeline",
        "name": "02 Demo - Course Setup and Creating a Pipeline",
        "relative_path": "../../02 Demo - Course Setup and Creating a Pipeline",
        "env_key": "course_02",
    },
    {
        
        "task_key": "05 Demo - Developing a Simple Pipeline",
        "depends_on": [
            {"task_key": "02 Demo - Course Setup and Creating a Pipeline"},
        ],
        "name": "05 Demo - Developing a Simple Pipeline",
        "relative_path": "../../05 Demo - Developing a Simple Pipeline",
        "env_key": "course_05",
    },
    {
        "task_key": "07 Demo - Adding Data Quality Expectations",
        "depends_on": [
            {"task_key": "05 Demo - Developing a Simple Pipeline"},
        ],
        "name": "07 Demo - Adding Data Quality Expectations",
        "relative_path": "../../07 Demo - Adding Data Quality Expectations",
        "env_key": "course_07",
    },
    {
        "task_key": "08 Lab - Create a Pipeline",
        "depends_on": [
            {"task_key": "07 Demo - Adding Data Quality Expectations"},
        ],
        "name": "08 Lab - Create a Pipeline",
        "relative_path": "../../08 Lab - Create a Pipeline",
        "env_key": "course_08",
    },
    {
        "task_key": "10 Demo - Deploying a Pipeline to Production",
        "depends_on": [
            {"task_key": "08 Lab - Create a Pipeline"},
        ],
        "name": "10 Demo - Deploying a Pipeline to Production",
        "relative_path": "../../10 Demo - Deploying a Pipeline to Production",
        "env_key": "course_10",
    },
    {
        "task_key": "12 Demo - Change Data Capture with AUTO CDC with SCD TYPE 1",
        "depends_on": [
            {"task_key": "10 Demo - Deploying a Pipeline to Production"},
        ],
        "name": "12 Demo - Change Data Capture with AUTO CDC with SCD TYPE 1",
        "relative_path": "../../12 Demo - Change Data Capture with AUTO CDC with SCD TYPE 1",
        "env_key": "course_12",
    },
    {
        "task_key": "14 Bonus Lab - AUTO CDC INTO with SCD Type 1",
        "depends_on": [
            {"task_key": "12 Demo - Change Data Capture with AUTO CDC with SCD TYPE 1"},
        ],
        "name": "14 Bonus Lab - AUTO CDC INTO with SCD Type 1",
        "relative_path": "../../14 Bonus Lab - AUTO CDC INTO with SCD Type 1",
        "env_key": "course_14",
    },
]
