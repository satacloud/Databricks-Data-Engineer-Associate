...
# MAGIC %md
# MAGIC # 02 - Deploying the Databricks Assets
# MAGIC
...
# MAGIC %run ../Includes/Classroom-Setup-CD

# COMMAND ----------

# MAGIC %md
# MAGIC ## B. Create the Databricks Job with Notebooks, Python Files and a Apache Spark™ Declarative Pipeline
# MAGIC
...
# MAGIC **FINAL JOB**
# MAGIC
# MAGIC ![Final SDK Workflow](https://files.training.databricks.com/binder/prod_main/devops-essentials-for-data-engineering-en_us-2.2.1/images/20260819T031035Z/DevOps Essentials for Data Engineering/Course Notebooks/Includes/images/05_final_sdk_workflow.png)

# COMMAND ----------

# MAGIC %md
# MAGIC 2. During development, it's beneficial to build out your Workflow and/or Spark Declarative Pipeline using the UI. The UI provides an easy way to build your desired job, and it generates the necessary JSON or YAML files to start automating your deployment across different environments.
# MAGIC
...
## Confirm the pipeline from the previous demonstration exists. If not, create the Spark Declarative Pipeline and store the ID
...
# MAGIC ![Final SDK Workflow Desc](https://files.training.databricks.com/binder/prod_main/devops-essentials-for-data-engineering-en_us-2.2.1/images/20260819T031035Z/DevOps Essentials for Data Engineering/Course Notebooks/Includes/images/05_Final_Workflow_Desc.png)
# MAGIC
...
# MAGIC
# MAGIC    **NOTE:** If the Spark Declarative Pipeline has already completed, simply select the pipeline link.
# MAGIC
...
# MAGIC
# MAGIC     a. SDK Code: **[../Includes/Classroom-Setup-CD]($../Includes/Classroom-Setup-CD)**
# MAGIC
# MAGIC     b. Scroll down to cell 4: `def create_demo_cd_job(my_pipeline_id, job_name)` 
# MAGIC     
...
# MAGIC
# MAGIC Think about the following for deploying this project utilizing the entire CI/CD process:
...
# MAGIC - How do I configure the necessary variables for the Spark Declarative Pipeline during each deployment?
