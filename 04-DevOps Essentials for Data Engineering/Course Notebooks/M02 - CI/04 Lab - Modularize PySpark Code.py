...
# MAGIC %md
# MAGIC # 04 Lab - Modularize PySpark Code
# MAGIC
...
# MAGIC
# MAGIC ##### The notebook "03 Demo - Modularizing PySpark Code - Required" sets up the catalogs for this course. If you have not run this notebook, the catalogs will not be available.
